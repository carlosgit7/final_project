<template>
  <div class="flex flex-col w-2/3 mx-auto mt-16 p-10 text-xl font-light bg-blue-700 rounded-lg shadow-md items-center justify-center overflow-hidden text-center">
    ...
    <h3 class="text-white mt-5 italic">"Everyone has inside them a piece of good news. The good news is you don't know how great you can be! How much you can love! What you can accomplish! And what your potential is." - Anne Frank.</h3>
    <h3 class="text-white mt-5 mb-5 italic">If you need some encouragement today or if you'd like to encourage others click 
    <router-link to="/" class="mt-5 text-orange-500 hover:text-orange-300">here</router-link> to sign up.</h3>
